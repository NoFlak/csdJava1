...
public class SalesReport
{
   public static void main(String[] args)
   {
      ...
      //db: note that no exception will be generated
      //by this code;
      //author just wants to show that you can have
      //multiple exception handlers with "1" try block
      try
      {
         ...
         //db: close the scanner and the file it is based off of
         inputFile.close();
