 ...
 * Notes after the assignment:
 * - This was a very difficult assignment for me, and I had to go back and review previous assignments to figure out what I did wrong.
 * - In all honesty not a single line of this code worked on the first try and made me review older assignments and examples to get an idea of what I did wrong. 
 * - I had to redesign the methods multiple times to get it to work in several places with that help... I left notes in the code to help me remember what I did and why I did it.
 */
public class TicTacToe {
     ...
     * Issue - Does not find a win.
     * Fixed by adding return for checkRows, checkColumns, and checkDiagonals in method.
     */
    ...
    /**
     * Main method to start the game was missing. This main call fixed issue from 5/30/2025 on Line 14
     */
